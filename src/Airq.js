...
const Airq=()=>{
    ...
    {display&& <div className="airquality">
        ...
        <progress value={display.list[0].components.co} max="300">{display.list[0].components.co}</progress></div>
        ...
        <div className="nitrogen">nitrogen dioxide {display.list[0].components.no2}
        <progress value={Math.round(display.list[0].components.no2)} max="5">{display.list[0].components.no2}</progress></div>

        <div className="ozon">Ozone {display.list[0].components.o3}
        <progress value={display.list[0].components.o3} max="100">{display.list[0].components.o3}</progress></div>
        ...
        <progress value={display.list[0].components.pm10} max="6">{display.list[0].components.pm10}</progress></div>
